...
class TestPredicate(unittest.TestCase):
    ...
    def test_predicates_application(self):
        ...
        self.assertEqual(
            appPredicate.makeScriptMethodCall(True), 'application("dummy")')
    ...
    def test_predicates_window_named(self):
        ...
        self.assertEqual(
            frameNamedPredicate.makeScriptMethodCall(False), 'window("dummy")')
        self.assertEqual(
            frameNamedPredicate.makeScriptVariableName(), 'dummyWin')
    ...
    def test_predicates_menu_named(self):
        ...
        self.assertEqual(menuNamedPredicate.makeScriptMethodCall(
            False), 'menu("dummy", recursive=False)')
        self.assertEqual(
            menuNamedPredicate.makeScriptVariableName(), 'dummyMenu')
    ...
    def test_predicates_menu_item_named(self):
        ...
        self.assertEqual(menuItemNamedPredicate.makeScriptMethodCall(
            False), 'menuItem("dummy", recursive=False)')
        self.assertEqual(
            menuItemNamedPredicate.makeScriptVariableName(), 'dummyMenuItem')
    ...
    def test_predicates_text_entry_named(self):
        ...
        self.assertEqual(textNamedPredicate.makeScriptMethodCall(
            False), 'textentry("dummy", recursive=False)')
        self.assertEqual(
            textNamedPredicate.makeScriptVariableName(), 'dummyEntry')
    ...
    def test_predicates_button_named(self):
        ...
        self.assertEqual(buttonNamedPredicate.makeScriptMethodCall(
            False), 'button("dummy", recursive=False)')
        self.assertEqual(
            buttonNamedPredicate.makeScriptVariableName(), 'dummyButton')
    ...
    def test_predicates_page_tab_named(self):
        ...
        self.assertEqual(pageTabNamedPredicate.makeScriptMethodCall(
            False), 'tab("dummy", recursive=False)')
        self.assertEqual(
            pageTabNamedPredicate.makeScriptVariableName(), 'dummyTab')
    ...
    def test_predicates_generic_by_name(self):
        ...
        self.assertEqual(
            genericPredicateByName.makeScriptVariableName(), 'dummyName1Node')
    ...
    def test_predicates_generic_by_roleName(self):
        ...
        self.assertEqual(
            genericPredicateByRole.makeScriptVariableName(), 'dummyRole1Node')
    ...
    def test_predicates_generic_by_description(self):
        ...
        self.assertEqual(
            genericPredicateByDescription.makeScriptVariableName(), 'dummyDesc1Node')
    ...
    def test_predicates_generic_by_label(self):
        ...
        self.assertEqual(
            genericPredicateByLabel.makeScriptVariableName(), 'dummyName1Node')
    ...
    def test_predicates_named(self):
        ...
        self.assertEqual(genericNamedPredicate.makeScriptMethodCall(
            False), 'child(name="dummy name 1", recursive=False)')
        self.assertEqual(
            genericNamedPredicate.makeScriptVariableName(), 'dummyName1Node')
    ...
    def test_predicates_labelled_as(self):
        ...
        self.assertEqual(genericLabelledPredicate.makeScriptMethodCall(
            False), 'child(label="dummy name 1", recursive=False)')
        self.assertEqual(
            genericLabelledPredicate.makeScriptVariableName(), 'dummyName1Node')
    ...
    def test_predicates_dialog_named(self):
        ...
        self.assertTrue(genericNamedPredicate.satisfiedByNode(dn1))
        self.assertEqual(genericNamedPredicate.makeScriptMethodCall(
            False), 'dialog("dummy name 1")')
        self.assertEqual(
            genericNamedPredicate.makeScriptVariableName(), 'dummyName1Dlg')
